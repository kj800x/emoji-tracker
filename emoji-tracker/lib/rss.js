...
exports.buildRssVerbose = exports.buildRss = void 0;
const template = ({ now, pubDate, newEmojis, totalCount, previousUpdateTime, }) => `<?xml version="1.0" encoding="UTF-8" ?>
<rss version="2.0">
<channel>
...
const verboseTemplate = ({ now, pubDate, newEmojis, totalCount, previousUpdateTime, }) => `<?xml version="1.0" encoding="UTF-8" ?>
<rss version="2.0">
<channel>
 <title>New ${process.env["SLACK_WORKSPACE"]} Emojis</title>
 <description>Coolkev's ${process.env["SLACK_WORKSPACE"]} "New Emojis" RSS feed</description>
...
function buildRss(now, newEmojis, previousUpdateTime, totalCount) {
...
function buildRssVerbose(now, newEmojis, previousUpdateTime, totalCount) {
    const pubDate = new Date(now);
    // pubDate.setHours(7);
    // pubDate.setMinutes(0);
    pubDate.setSeconds(0);
...
exports.buildRssVerbose = buildRssVerbose;
